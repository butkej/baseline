...
parser.add_argument(
    "--adressExp",
    type=str,
    default=r"L:\Experiments\TCGA_RESNET18_TESTFULL_WithZenodoModel.txt",
    help="Adress to the experiment File",
)
parser.add_argument(
    "--modelAdr",
    type=str,
    default=r"C:\Users\nghaffarilal\sciebo\deepHistology\labMembers\Narmin\Utils\Exp5_MODEL_Full",
...
if __name__ == "__main__":
    ...
    for key in list(args.target_labelDict.keys()):
        ...
        for item in probsList:
            probs[key].append(
                item[utils.get_value_from_key(args.target_labelDict, key)]
            )
    ...
    GenerateHighScoreTiles_Classic(
