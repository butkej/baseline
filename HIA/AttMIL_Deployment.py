...
parser.add_argument(
    "--adressExp",
    type=str,
    default=r"L:\Experiments\DACHS_RESNET50_TestFull.txt",
    help="Adress to the experiment File",
)
parser.add_argument(
    "--modelAdr",
    type=str,
    default=r"L:\Experiments\DACHS_RESNET50_TRAINFULL_isMSIH_1\RESULTS\bestModel",
...
if __name__ == "__main__":
    ...
    for targetLabel in targetLabels:
        ...
        args.projectFolder = utils.CreateProjectFolder(
            args.project_name, args.adressExp, targetLabel, args.model_name
        )
        ...
        testResultsPath = os.path.join(
            args.result_dir, "TEST_RESULT_TILE_BASED_FULL.csv"
        )
