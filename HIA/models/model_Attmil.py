...
class MILBagTransform(Transform):
    def __init__(
        self, valid_files: Iterable[os.PathLike], max_bag_size: int = 512
    ) -> None:
...
class MILModel(nn.Module):
    ...
    def forward(self, bags_and_lens):
        ...
        return (
            (scores, masked_attention_scores) if self.with_attention_scores else scores
        )
