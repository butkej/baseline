...
def eval(model, n_class):
    ...
    output_file = f"test_predict/{model}_predict.csv"
    output_cmat = f"test_predict/{model}_cmat.csv"
    ...
    for i in range(5):
        ...
        result_file = f"test_result/{model}_test_cv-{i+1}.csv"
        ...
        (
            ...
            pred_label_tmp,
            max_prob_tmp,
        ) = get_slide_prob_label(result_file, n_class)
